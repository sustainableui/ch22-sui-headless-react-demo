...
function getClosestAzureRegion(userCoords, azureRegions) {
    const azureRegionsDistances = azureRegions.map((azureRegion) => distance(userCoords, {
    ...
    const closestAzureRegionIndex = azureRegionsDistances.findIndex(azureRegionsDistance => azureRegionsDistance === closestAzureRegionDistance)
